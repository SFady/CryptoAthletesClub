  ...
  return (
    <>
      <div className="container">
        ...
        <main>
          <h1 className="ombre">Liste des activités</h1>
          <p className="details-texte">Détail des activités enregistrées</p>
	<br/>
	<DefitPrice /> 
...
.ombre {
 ...
 color: #d6ccff; /* texte violet très clair mais pas blanc */
